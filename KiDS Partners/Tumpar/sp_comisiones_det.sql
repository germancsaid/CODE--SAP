...
SELECT
TO_DATE(TO_NVARCHAR("Fecha_Contable", 'YYYY-MM-DD')) AS "Fecha_Contable",--+linea modificaciones v2 10-07
"Time",
"Numero_de_Asiento",--+linea modificaciones v2 10-07
TO_DATE(TO_NVARCHAR("Fecha_de_Documento", 'YYYY-MM-DD')) AS "Fecha_de_Documento",--+linea modificaciones v2 10-07
"Numero_de_Documento",--+linea modificaciones v2 10-07
"Tipo_de_Documento", --+linea modificaciones v2 10-07
"Codigo_Cliente",--+linea modificaciones v2 10-07
"Nombre_Cliente",--+linea modificaciones v2 10-07
"Vendedor",
TO_DATE(TO_NVARCHAR("Fecha_de_Pago", 'YYYY-MM-DD')) AS "Fecha_de_Pago",--+linea modificaciones v2 10-07
"Numero_de_Pago",--+linea modificaciones v2 10-07
"Monto",--+linea modificaciones v2 10-07
"Tipo",--+linea modificaciones v2 10-07
"Comentario",--+linea modificaciones v2 10-07
"Bono_Extra_Stock"--+linea modificaciones v2 10-07

FROM
(  
    -- PAGOS RECIBIDOS AL CONTADO DETALLADO
    SELECT
      T0."RefDate" AS "Fecha_Contable",
      T0."CreateTime" AS "Time",
      T0."Number" AS "Numero_de_Asiento",
      T1."DocDate" AS "Fecha_de_Pago", T1."DocNum" AS "Numero_de_Pago",
      T3."DocDate" AS "Fecha_de_Documento",
      T3."DocNum" AS "Numero_de_Documento",
      T1."CardCode" AS "Codigo_Cliente",
      T1."CardName" AS "Nombre_Cliente",
	    CASE WHEN T1."Comments" IS NULL THEN T1."JrnlMemo" ELSE T1."Comments" END AS "Comentario",
      CASE WHEN T2."InvType" = '13' THEN 'Factura' ELSE '' END AS "Tipo_de_Documento",
      'Contado' AS "Tipo",
    ...
    SELECT
      ...
      T0."Number" AS "Numero_de_Asiento",
      T1."DocDate" AS "Fecha_de_Pago", T1."DocNum" AS "Numero_de_Pago",
      T1."DocDate" AS "Fecha_de_Documento",
      T1."DocNum" AS "Numero_de_Documento",
      T1."CardCode" AS "Codigo_Cliente",
      T1."CardName" AS "Nombre_Cliente",
	    CASE WHEN T1."Comments" IS NULL THEN T1."JrnlMemo" ELSE T1."Comments" END AS "Comentario",
      'Pago Anticipo' AS "Tipo_de_Documento",
      'Anticipo' AS "Tipo",
      0 AS "Bono_Extra_Stock",
    ...
    SELECT
      ...
      T0."Number" AS "Numero_de_Asiento",
      T1."DocDate" AS "Fecha_de_Pago", T1."DocNum" AS "Numero_de_Pago",
      T3."RefDate" AS "Fecha_de_Documento",
      T3."Number" AS "Numero_de_Documento",
      T1."CardCode" AS "Codigo_Cliente",
      T1."CardName" AS "Nombre_Cliente",
	    CASE WHEN T1."Comments" IS NULL THEN T1."JrnlMemo" ELSE T1."Comments" END AS "Comentario",
      CASE WHEN T2."InvType" = '30' THEN 'Asiento' ELSE '' END AS "Tipo_de_Documento",
      'Credito AS' AS "Tipo",
      0 AS "Bono_Extra_Stock",
    ...
    SELECT
      ...
      T1."CardName" AS "Nombre_Cliente",
	    CASE WHEN T1."Comments" IS NULL THEN T1."JrnlMemo" ELSE T1."Comments" END AS "Comentario",
      CASE WHEN T2."InvType" = '14' THEN 'Nota de Credito' ELSE '' END AS "Tipo_de_Documento",
      'Devolucion' AS "Tipo",
      0 AS "Bono_Extra_Stock",
      CASE WHEN T4."SlpName" IS NOT NULL THEN T4."SlpName" ELSE T1."U_VENDEDOR" END AS "Vendedor",
    ...
    SELECT
      ...
      T1."CardName" AS "Nombre_Cliente",
	    CASE WHEN T1."Comments" IS NULL THEN T1."JrnlMemo" ELSE T1."Comments" END AS "Comentario",
      CASE WHEN T2."InvType" = '24' THEN 'Pago Recibido' ELSE '' END AS "Tipo_de_Documento",
      'Devolucion' AS "Tipo",
      0 AS "Bono_Extra_Stock",
      T1."U_VENDEDOR" AS "Vendedor",
      CASE 
...
ORDER BY "Fecha_de_Pago", "Vendedor"
