ALTER PROCEDURE KDS_COMISIONES_TOT (in fdesde date, in fhasta date) 
...
"NOTAS_CREDITO",
"DEVOLUCIONES_PAGOS",
("CONTADO" + "CREDITO" + "ANTICIPO" + "OTROS" + "NOTAS_CREDITO" + "DEVOLUCIONES_PAGOS") AS "TOTAL_USD"
FROM
(  
  ...
  SELECT U."SlpCode" AS "CODE", U."SlpName" AS "VENDEDOR", U."U_CentroCosto" AS "CC",
    ...
    CASE WHEN PR."Monto" <> 0 THEN PR."Monto" ELSE 0 END AS "DEVOLUCIONES_PAGOS"
  FROM OSLP U
    LEFT JOIN (
...
WHERE
("CONTADO" + "CREDITO" + "ANTICIPO" + "OTROS" + "NOTAS_CREDITO" + "DEVOLUCIONES_PAGOS") > 0
